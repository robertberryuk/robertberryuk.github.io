...
Table 1.1.2 First 10 rows of database
```{r echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE}
#> Head
head(db)
```
...
#> Subset, selecting only Cornwall (inc Isles of Scilly), Devon, Somerset, and Dorset
