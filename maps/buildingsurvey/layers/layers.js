...
var format_National_Character_Areas___Natural_England_2 = new ol.format.GeoJSON();
var features_National_Character_Areas___Natural_England_2 = format_National_Character_Areas___Natural_England_2.readFeatures(json_National_Character_Areas___Natural_England_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_National_Character_Areas___Natural_England_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_National_Character_Areas___Natural_England_2.addFeatures(features_National_Character_Areas___Natural_England_2);
var lyr_National_Character_Areas___Natural_England_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_National_Character_Areas___Natural_England_2, 
                style: style_National_Character_Areas___Natural_England_2,
                interactive: true,
                title: '<img src="styles/legend/National_Character_Areas___Natural_England_2.png" /> National_Character_Areas___Natural_England'
            });
...
lyr_National_Character_Areas___Natural_England_2.set('fieldImages', {'FID': 'Range', 'JCACODE': 'TextEdit', 'JCANAME': 'TextEdit', 'NCA_Name': 'TextEdit', 'NAID': 'TextEdit', 'NANAME': 'TextEdit', 'Area_SqKM': 'TextEdit', 'Hotlink': 'TextEdit', 'GlobalID': 'TextEdit', 'SHAPE_Leng': 'TextEdit', 'SHAPE_Area': 'TextEdit', });
...
lyr_National_Character_Areas___Natural_England_2.set('fieldLabels', {'FID': 'no label', 'JCACODE': 'no label', 'JCANAME': 'no label', 'NCA_Name': 'inline label', 'NAID': 'no label', 'NANAME': 'no label', 'Area_SqKM': 'no label', 'Hotlink': 'no label', 'GlobalID': 'no label', 'SHAPE_Leng': 'no label', 'SHAPE_Area': 'no label', });
