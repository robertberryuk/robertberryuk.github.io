...
lyr_GoogleHybrid_0.setVisible(true);lyr_NPs_1.setVisible(true);lyr_NP_Office_2.setVisible(true);lyr_Contractor_3.setVisible(true);lyr_Architect_4.setVisible(true);lyr_Building_5.setVisible(true);lyr_Applicant_6.setVisible(true);
