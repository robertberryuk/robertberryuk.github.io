...
- **Step 3**: For each boundary area, calculate the total AES payments for each year represented in the data layer. Note, the approaches for calculating annual totals ES and CS differ due to the structural differences of the datasets. This is quite complex and is fully documented in the R code.
